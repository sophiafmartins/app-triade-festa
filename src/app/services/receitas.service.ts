...
export class ReceitasService {
  ...
  public receitas: Receita[] = [
    //Bolo de cenoura
    {
      ...
      porcoes: 8,
      tempo: 40,
      ingrdFiltro: ['Óleo', 'Cenoura', 'Ovo', 'Açúcar', 'Farinha de trigo', 'Fermento em pó', 'Manteiga', 'Chocolate em pó', 'Leite'],
      ingredientes: [
        {
          titulo: '',
          descricao: []
    ...
    //Torta de frango
    {
      ...
      porcoes: 15,
      tempo: 40,
      ingrdFiltro: ['Frango', 'Caldo de galinha', 'Óleo', 'Alho', 'Cebola', 'Tomate', 'Ervilha', 'Sal', 'Pimenta-do-reino', 'Leite', 'Ovo', 'Farinha de trigo', 'Fermento em pó', 'Queijo'],
      ingredientes: [
        {
          titulo: '',
          descricao: []
    ...
    //Salada
    {
      ...
      porcoes: 6,
      tempo: 30,
      ingrdFiltro: ['Alface', 'Cenoura', 'Beterraba', 'Tomate', 'Cebola', 'Sal', 'Açúcar', 'Azeite', 'Vinagre'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
    ...
    //Beijinho
    {
      ...
      porcoes: 50,
      tempo: 20,
      ingrdFiltro: ['Leite condensado', 'Manteiga', 'Coco', 'Açúcar', 'Cravos-da-índia'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
    ...
    //Torta de limão
    {
      ...
      porcoes: 15,
      tempo: 40,
      ingrdFiltro: ['Biscoito de maisena', 'Margarina', 'Leite condensado', 'Creme de leite', 'Limão', 'Ovo', 'Açúcar'],
      ingredientes: [
        {
          titulo: '',
          descricao: []
    ...
    //Macarrão a bolonhesa
    {
      ...
      porcoes: 6,
      tempo: 45,
      ingrdFiltro: ['Cebola', 'Azeite', 'Azeitona', 'Molho de tomate', 'Caldo de carne', 'Cenoura', 'Tomate', 'Macarrão', 'Carne moída'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
    ...
    //Salada de frutas
    {
      ...
      porcoes: 6,
      tempo: 10,
      ingrdFiltro: ['Leite condensado', 'Limão', 'Morango', 'Laranja', 'Kiwi', 'Manga', 'Frutas'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
    ...
    //Lasanha de frango
    {
      ...
      porcoes: 4,
      tempo: 45,
      ingrdFiltro: ['Frango', 'Queijo', 'Presunto', 'Massa de lasanha', 'Requeijão', 'Caldo de galinha', 'Leite', 'Creme de leite', 'Farinha', 'Manteiga', 'Cebola'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
    ...
    //Brigadeiro
    {
      ...
      porcoes: 30,
      tempo: 25,
      ingrdFiltro: ['Leite condensado', 'Margarina', 'Chocolate em pó', 'Achocolatado', 'Chocolate granulado'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
    ...
    //Arroz com brócolis
    {
      ...
      porcoes: 6,
      tempo: 30,
      ingrdFiltro: ['Arroz', 'Alho', 'Azeite', 'Brócolis', 'Bicarbonato de sódio', 'Água', 'Sal'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
    ...
    //Bolo de laranja
    {
      ...
      porcoes: 12,
      tempo: 40,
      ingrdFiltro: ['Ovo', 'Açúcar', 'Óleo', 'Laranja', 'Farinha de trigo', 'Fermento'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
    ...
    //Curau de milho
    {
      ...
      porcoes: 14,
      tempo: 15,
      ingrdFiltro: ['Milho', 'Açúcar', 'Leite', 'Amido de milho'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
    ...
    //Couve-flor gratinada
    {
      ...
      porcoes: 8,
      tempo: 30,
      ingrdFiltro: ['Couve-flor', 'Requeijão', 'Ovo', 'Queijo', 'Mussarela', 'Cheiro-verde', 'Tomate', 'Margarina'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
    ...
    //Batata recheada
    {
      ...
      porcoes: 2,
      tempo: 30,
      ingrdFiltro: ['Batata', 'Sal', 'Pimenta-do-reino', 'Ovo', 'Queijo', 'Bacon', 'Creme de leite', 'Cebolinha'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
    ...
    //Esfiha de carne
    {
      ...
      porcoes: 30,
      tempo: 90,
      ingrdFiltro: ['Fermento', 'Açúcar', 'Sal', 'Leite', 'Água', 'Ovo', 'Farinha de trigo', 'Óleo', 'Carne moída', 'Tomate', 'Cebola', 'Alho', 'Azeitona', 'Noz moscada', 'Salsinha', 'Cebolinha', 'Molho de pimenta', 'Gema', 'Gergelim'],
      ingredientes: [
        {
          titulo: '',
          descricao: [
  ...
  private saveToStorage(){
    this.storage.set("receitas", this.receitas);
  }

  private async loadFromStorage(){
    const loadedReceitas = await this.storage.get("receitas");
    if(loadedReceitas){
      this.receitas.push(...loadedReceitas);
    }
  ...
  public deleteReceitas(id: number){
    const index = this.receitas.findIndex(r => r.id === id);
    this.receitas.splice(index, 1);
    this.saveToStorage();
  }

  public statusFavoritos(id: number){
